package test.commerce.seller.issueToken;
...
public class POST_specs {
    ...
    void 올바르게_요청하면_200_OK_상태코드를_반환한다(@Autowired TestRestTemplate client) {
        ...
        ResponseEntity<AccessTokenCarrier> response = client.postForEntity("/seller/issuetoken",
    ...
    @Test
    void 올바르게_요청하면_200_접근_토큰을_반환한다(@Autowired TestRestTemplate client) {
        //Arrange
        String email = generateEmail();
        String password = generatePassword();
